...
public class Sign_In extends AppCompatActivity implements ZXingScannerView.ResultHandler{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            new CurrentUser(pref.getString("user",null),pref.getString("pass",null),pref.getString("sclass",null),pref.getString("ssec",null),pref.getString("idate",null),pref.getString("adate",null),pref.getString("vdate",null),pref.getString("fdate",null),pref.getString("tdate",null),pref.getString("type",null));
        ...
        signupbut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Sign_In.this,AA_home.class);
                startActivity(intent);
...
//                    {
                    ...
                    if(cred_update!=null) {
                        ...
                        if ((uname.equals(usn)) && (password.equals(pass))) {
                            ...
                            editor.commit();
                            new CurrentUser(uname, password, cred_update.cls, cred_update.sec, cred_update.idate, cred_update.adate, cred_update.vdate, cred_update.fdate, cred_update.tdate,cred_update.type);
