...
public class Off_Dis_files extends AppCompatActivity {

    TextView textView5,textView15, textView16, textView17, textView18, change_status;
    EditText editText2;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.off_discussions_files);
...
//        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        ...
        change_status.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(Off_Dis_files.this);
